...
void renderdoc_start_capture(const RenderdocApi *api) { api->StartFrameCapture(NULL, NULL); }
void renderdoc_end_capture(const RenderdocApi *api) { api->EndFrameCapture(NULL, NULL); }
}