...
const COORDS_0 : array<vec3<f32>, i32(36)> = array<vec3<f32>, i32(36)>( vec3<f32>(-1.0f, 1.0f, -1.0f), vec3<f32>(-1.0f, -1.0f, -1.0f), vec3<f32>(1.0f, -1.0f, -1.0f), vec3<f32>(1.0f, -1.0f, -1.0f), vec3<f32>(1.0f, 1.0f, -1.0f), vec3<f32>(-1.0f, 1.0f, -1.0f), vec3<f32>(-1.0f, -1.0f, 1.0f), vec3<f32>(-1.0f, -1.0f, -1.0f), vec3<f32>(-1.0f, 1.0f, -1.0f), vec3<f32>(-1.0f, 1.0f, -1.0f), vec3<f32>(-1.0f, 1.0f, 1.0f), vec3<f32>(-1.0f, -1.0f, 1.0f), vec3<f32>(1.0f, -1.0f, -1.0f), vec3<f32>(1.0f, -1.0f, 1.0f), vec3<f32>(1.0f, 1.0f, 1.0f), vec3<f32>(1.0f, 1.0f, 1.0f), vec3<f32>(1.0f, 1.0f, -1.0f), vec3<f32>(1.0f, -1.0f, -1.0f), vec3<f32>(-1.0f, -1.0f, 1.0f), vec3<f32>(-1.0f, 1.0f, 1.0f), vec3<f32>(1.0f, 1.0f, 1.0f), vec3<f32>(1.0f, 1.0f, 1.0f), vec3<f32>(1.0f, -1.0f, 1.0f), vec3<f32>(-1.0f, -1.0f, 1.0f), vec3<f32>(-1.0f, 1.0f, -1.0f), vec3<f32>(1.0f, 1.0f, -1.0f), vec3<f32>(1.0f, 1.0f, 1.0f), vec3<f32>(1.0f, 1.0f, 1.0f), vec3<f32>(-1.0f, 1.0f, 1.0f), vec3<f32>(-1.0f, 1.0f, -1.0f), vec3<f32>(-1.0f, -1.0f, -1.0f), vec3<f32>(-1.0f, -1.0f, 1.0f), vec3<f32>(1.0f, -1.0f, -1.0f), vec3<f32>(1.0f, -1.0f, -1.0f), vec3<f32>(-1.0f, -1.0f, 1.0f), vec3<f32>(1.0f, -1.0f, 1.0f) );
struct VSOut_0
{
